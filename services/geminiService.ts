...
export const getPerformanceInsights = async (sales: SalesRecord[], name: string) => {
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: `Analyze this sales performance for ${name}: ${summary}. Provide 3 short actionable tips to increase sales and profit for Elder Pharma. Keep it professional and motivational.`,
      config: {
